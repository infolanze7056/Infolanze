...
const WebProjects = () => {
  ...
  const projects = [
    { img: Bsynk, title: "Bsynk", link: "https://accounts.abss.ai" },
    { img: Isx, title: "ISX Canada", link: "https://isx-frontend.store/" },
    { img: Hydropod, title: "Hydropod", link: "https://hydropod.in/" },
    { img: BetterrWater, title: "Better Water", link: "https://resin-admin-panel.vercel.app/" },
    { img: Biogenix, title: "Biogenix", link: "https://www.biogenixcompostable.com/" },
    { img: Quosha, title: "Quosha", link: "https://www.quosha.store/" },
    { img: Doshion, title: "Doshion" },
    { img: Popsocket, title: "Popsockets", link: "https://www.popsockets.com/" },
    { img: Partake, title: "Partake Foods", link: "https://partakefoods.com/" },
    { img: Gym, title: "Gym Shark", link: "https://row.gymshark.com/" },
    { img: xbeat, title: "X-BEAT", link: "https://demo-x-beat.vercel.app/" },
    { img: shopit, title: "SHOP IT", link: "https://demo-shop-it.vercel.app/" },
    { img: beach, title: "BEACH RESORT", link: "https://demo-resort.vercel.app/" },
    { img: teaofassam, title: "TEA OF ASSAM", link: "https://demo-tea-of-assam.vercel.app/" },
  ];

  // Skeleton count will match project count
  const skeletons = Array(projects.length).fill(0);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 xl:gap-10 md:gap-5 gap-8">
        ...
        {loading &&
          skeletons.map((_, index) => (
            <div key={index} className="shadow-2xl rounded-3xl border border-[#eee] animate-pulse">
              <div className="w-full h-64 bg-gray-200 rounded-t-3xl"></div>
              <div className="bg-white text-center rounded-b-3xl p-4">
                <div className="h-5 w-1/2 bg-gray-200 mx-auto rounded"></div>
              </div>
            </div>
          ))}
              ...
              <div className="shadow-2xl rounded-3xl border border-[#eee]">
                <div className="relative m-auto overflow-hidden rounded-t-3xl">
                  <img
                    src={p.img}
                    alt={p.title}
                    className="hover:scale-[1.08] transition-all duration-[0.5s]"
                  />
                </div>
                <div className="bg-white text-black text-center lg:text-sm rounded-b-3xl p-2 uppercase">
                  <h1>{p.title}</h1>
