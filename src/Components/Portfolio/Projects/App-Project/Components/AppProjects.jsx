...
const AppProjects = () => {
  ...
  // App Projects list
  const projects = [
    { img: Hydropod, name: "Hydropod", link: null },
    { img: bw, name: "Better Water", link: null },
    {
      img: Doshion,
      name: "Doshion",
      link: "https://play.google.com/store/apps/details?id=com.techteam807.waterroapp",
    },
    {
      img: Kiku,
      name: "Kikuu Shopping",
      link: "https://play.google.com/store/apps/details?id=com.kikuu",
    },
    {
      img: Attnd,
      name: "Attnd: Employee Management",
      link: "https://play.google.com/store/apps/details?id=com.trillionbits.attndadmin",
    },
    {
      img: Task,
      name: "Taskito",
      link: "https://play.google.com/store/apps/details?id=com.fenchtose.reflog",
    },

    {
      img: Oda,
      name: "ODA Class",
      link: "https://play.google.com/store/apps/details?id=com.yyinedu.pigeon",
    },
  ];
  ...
  return (
    <div className="bg-white lg:px-28 md:px-20 px-5 py-10 pb-20">
      <div className="relative z-10 text-center mb-16">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight mb-5 font-poppins">
          Our <span className="text-[--second-color]">App Development</span>{" "}
          Projects
        </h1>
        <p className="text-gray-600 max-w-2xl mx-auto font-nunito text-base md:text-lg leading-relaxed">
          Discover our innovative app projects designed to deliver smooth
          performance, engaging UI, and great user experiences.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 xl:gap-10 md:gap-5 gap-8">
        {/* ---------- Skeleton Loader (matches project count) ---------- */}
        {loading &&
