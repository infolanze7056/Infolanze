...
function ServiceHero({title, description}) {
  return (
    <div className='font-family herosection'>
        <div className='px-5 md:px-20 lg:px-52 lg:pb-28 lg:pt-20 md:pb-44 md:pt-40 pb-20 pt-6'>
            <div className='text-center'>
                <div className='lg:text-6xl md:text-6xl text-2xl font-semibold mx-auto max-w-3xl lg:pb-7 md:pb-7 pb-4'>{title}</div>
