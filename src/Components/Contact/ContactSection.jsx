      ...
      const response = await fetch(
        "https://contact-backend-zeta.vercel.app/api/contact/Infolanze-contact",
        {
          ...
          body: JSON.stringify({
            ...
            phone: formData.phone_number, // ✅ backend expects "phone"
            description: formData.company_name, // ✅ backend expects "description"
          }),
        }
      );
          ...
          <div className="font-family">
            <div className="-mx-4 flex flex-wrap lg:justify-between">
              ...
              <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-2 sm:p-12 border">
                  <form onSubmit={handleSubmit}>
                    <div className="mb-6">
                      <input
                        ...
                        className="w-full rounded border border-stroke px-[14px] py-3 text-base text-body-color outline-none focus:border-primary dark:border-[#6b7280] dark:bg-dark dark:text-dark-6"
                      />
                    </div>
                    <div className="mb-6">
                      <input
                    ...
                    <div>
                      <button
                        type="submit"
                        disabled={loading}
                        className="w-full rounded border border-primary bg-[#25aae1] p-3 text-white transition hover:bg-blue-500 hover:text-white"
                      >
                         {loading ? (
