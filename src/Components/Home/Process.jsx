    ...
    <div className="lg:px-36 md:px-24 px-4 py-10 bg-[#e9f6fc] font-family">
        ...
        <div className='grid lg:grid-cols-6 md:grid-cols-2 grid-cols-1 gap-10 px-5 lg:text-left md:text-left text-center py-5'>
            <div>
                ...
                <div className='text-sm'>Whether it's brand new website design or an existing website restructuing...</div>
            </div>
            ...
            <div>
                ...
                <div className='text-sm'>Quality assuranceis an important step in the website development process...</div>
            </div>
            <div className='lg:pt-16 md:pt-16'>
                <div className="">
                ...
                <div className='text-sm'>User acceptance is a type of testing performed by the client to certify the...</div>
            </div>
            <div>
                <div className="">
                ...
                <div className='text-sm'>Finally..!!! Launching a Website or Web application..!!! All processes are done...</div>
            </div>
            <div className='lg:pt-16 md:pt-16'>
                <div className="">
                ...
                <div className='text-sm'>Just likea house or a business, a website needs to be secure nad regularly...</div>
            </div>
        </div>
    </div>
    </div>
