      ...
      <div className="bg-white lg:px-28 md:px-20 px-5 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 py-5">
          ...
          <div className="lg:border-l-4 lg:pl-12 lg:col-span-2 border-[--second-color]">
            <h1 className="lg:text-4xl md:text-4xl text-2xl font-semibold uppercase text-[--second-color] py-10 lg:text-left text-center">
              Website Devlopment
            </h1>
            <p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 py-5">
          <div className="lg:border-r-4 lg:pr-12 lg:col-span-2 border-[--second-color] order-2 lg:order-1">
            <h1 className="lg:text-4xl md:text-4xl text-xl font-semibold uppercase text-[--second-color] py-10 lg:text-left text-center">
          ...
          <img src={App} alt="" className="order-1 lg:order-2" />
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 py-5">
